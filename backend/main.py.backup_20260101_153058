...
from fastapi.staticfiles import StaticFiles, Depends, HTTPException, status
...
from lottery_integration import router as lottery_router
...
# הוספת routers
app.include_router(lottery_router)  # מוסיף את router הלוטו
...
# הגשת קבצים סטטיים מ-React frontend (לצורך פריסה ב-Railway)
try:
    app.mount("/", StaticFiles(directory="static", html=True), name="static")
except:
    pass  # אם אין תיקיית static, זה בסדר
